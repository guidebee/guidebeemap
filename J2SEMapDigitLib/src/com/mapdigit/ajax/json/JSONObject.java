 ...
 */
public class JSONObject implements IJSONPath{
     ...
     */
    public static JSONObject fromXMLString(String xmlString) throws JSONException{
     ...
     * @return a XML string.
     */
    public String toXMLString(String tagName) throws JSONException{
    ...
    static JSONObject apply(final JSONObject start, final Vector tokens,
            final int firstToken)   throws JSONException {
        ...
        for (int i = firstToken; i < nTokens; i++) {
            ...
            if (tok1.length() == 1 && JSONPathTokenizer.isDelimiter(tok1.charAt(0))) {
