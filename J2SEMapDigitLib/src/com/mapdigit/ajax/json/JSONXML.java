...
class JSONXML {
     ...
     * @return A JSONObject containing the structured data from the JSONXML string.
     ...
     * @param x       The JSONXMLTokener containing the source string.
     * @param context The JSONObject that will include the new material.
     * @param name    The tag name.
     * @return true if the close tag is processed.
     * @throws JSONException
     */
    private static boolean parse(JSONXMLTokener x, JSONObject context,
