 ...
 */
public abstract class MDirectionCommandAnalyzer {
     ...
     * private constructor.
     */
    private MDirectionCommandAnalyzer() {
    }


    private static String COMMAND_NO_TURN[];

    private static String COMMAND_BEAR_LEFT[];

    private static String COMMAND_TURN_LEFT[] ;
    ...
    private static String COMMAND_TURN_RIGHT[];

    private static String COMMAND_BEAR_RIGHT[];
    ...
    private static String COMMAND_KEEP_LEFT[] ;

    private static String COMMAND_KEEP_RIGHT[];
    ...
    private static String COMMAND_U_TURN[];
    ...
    static {
        ...
        try {
            COMMAND_NO_TURN = new String[]{
                        new String(new byte[]{(byte) 0xE5, (byte) 0x87, (byte) 0x8F,
                            (byte) 0xE9, (byte) 0x80, (byte) 0x9F, (byte) 0xE8, (byte) 0xA1,
                            (byte) 0x8C, (byte) 0xE9, (byte) 0xA9, (byte) 0xB6}, "utf-8"),//"减速行驶"
                        new String(new byte[]{(byte) 0xE7, (byte) 0x9B, (byte) 0xB4,
                            (byte) 0xE8, (byte) 0xA1, (byte) 0x8C}, "utf-8") //"直行"
                    };

            COMMAND_BEAR_LEFT = new String[]{
                        new String(new byte[]{(byte) 0xE5, (byte) 0x90, (byte) 0x91,
                            (byte) 0xE5, (byte) 0xB7, (byte) 0xA6, (byte) 0xE5, (byte) 0x89,
                            (byte) 0x8D, (byte) 0xE6, (byte) 0x96, (byte) 0xB9, (byte) 0xE8,
                            (byte) 0xA1, (byte) 0x8C, (byte) 0xE9, (byte) 0xA9,
                            (byte) 0xB6}, "utf-8") //  "向左前方行驶"
                    };

            COMMAND_TURN_LEFT = new String[]{
                        new String(new byte[]{(byte) 0xE5, (byte) 0xB7, (byte) 0xA6,
                            (byte) 0xE8, (byte) 0xBD, (byte) 0xAC}, "utf-8") // "左转"
                    };

            COMMAND_TURN_RIGHT = new String[]{
                        new String(new byte[]{(byte) 0xE5, (byte) 0x8F, (byte) 0xB3,
                            (byte) 0xE8, (byte) 0xBD, (byte) 0xAC}, "utf-8") //  "右转"
                    };

            COMMAND_BEAR_RIGHT = new String[]{
                        new String(new byte[]{(byte) 0xE5, (byte) 0x90, (byte) 0x91,
                            (byte) 0xE5, (byte) 0x8F, (byte) 0xB3, (byte) 0xE5, (byte) 0x89,
                            (byte) 0x8D, (byte) 0xE6, (byte) 0x96, (byte) 0xB9, (byte) 0xE8,
                            (byte) 0xA1, (byte) 0x8C, (byte) 0xE9, (byte) 0xA9,
                            (byte) 0xB6}, "utf-8") // "向右前方行驶"
                    };

            COMMAND_KEEP_LEFT = new String[]{
                        new String(new byte[]{(byte) 0xE9, (byte) 0x9D, (byte) 0xA0,
                            (byte) 0xE5, (byte) 0xB7, (byte) 0xA6}, "utf-8") //  "靠左"
                    };

            COMMAND_KEEP_RIGHT = new String[]{
                        new String(new byte[]{(byte) 0xE9, (byte) 0x9D, (byte) 0xA0,
                            (byte) 0xE5, (byte) 0x8F, (byte) 0xB3}, "utf-8") // "靠右"
                    };

            COMMAND_U_TURN = new String[]{
                        new String(new byte[]{(byte) 0xE5, (byte) 0xB7, (byte) 0xA6,
                            (byte) 0xE8, (byte) 0xBD, (byte) 0xAC, (byte) 0xE8, (byte) 0xB0,
                            (byte) 0x83, (byte) 0xE5, (byte) 0xA4, (byte) 0xB4}, "utf-8"),//"左转调头",
                        new String(new byte[]{(byte) 0xE5, (byte) 0x8F, (byte) 0xB3,
                            (byte) 0xE8, (byte) 0xBD, (byte) 0xAC, (byte) 0xE8, (byte) 0xB0,
                            (byte) 0x83, (byte) 0xE5, (byte) 0xA4, (byte) 0xB4}, "utf-8") // "右转调头",
                    };
        } catch (Exception e) {
            //new String(new byte[]{},"utf-8");
        }

        COMMAND_LIST = new String[][]{
                    ...
                    COMMAND_MERGE,
                    COMMAND_NO_TURN,
                    COMMAND_U_TURN, //COMMAND_DESTINATION_ON_THE_LEFT,
