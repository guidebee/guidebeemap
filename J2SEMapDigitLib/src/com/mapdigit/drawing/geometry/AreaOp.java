...
abstract class AreaOp {
    ...
    static abstract class CAGOp extends AreaOp {
    ...
    static class AddOp extends CAGOp {
    ...
    static class SubOp extends CAGOp {
    ...
    static class IntOp extends CAGOp {
    ...
    static class XorOp extends CAGOp {
    ...
    static class NZWindOp extends AreaOp {
    ...
    static class EOWindOp extends AreaOp {
    ...
    private static IComparatorEx YXTopComparator = new IComparatorEx() {
    ...
    public static void resolveLinks(Vector subcurves,
		...
		/*
                ...
                if (!connectchains && !connectlinks) {
                    ...
                    connectlinks =
                            (nextlink != null && lx < cx && obstructs(nextlink.getX(), cx, curlink));
                }
            }
            if (connectchains) {
