 ...
 */
public class QuadCurve implements IShape {
     ...
     *		shape boundary
     * @return a {@link IPathIterator} object that defines the boundary
     *		of the shape.
     */
     ...
     * @return a <code>IPathIterator</code> object that defines the
